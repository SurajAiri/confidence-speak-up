...
export function DashboardMock() {
  ...
  /*
   * The dashboard is designed at exactly 1000 × 625.
   *
   * Whatever size the laptop screen becomes, we calculate one uniform
   * scale factor and scale the complete dashboard together.
   */
  useEffect(() => {
  ...
  return (
    <div
      ref={containerRef}
      className="relative w-full h-full overflow-hidden bg-[#131313]"
    >
      <div
      ...
      >
        <div className="w-full h-full bg-[#131313] rounded-[10px] overflow-hidden flex text-on-surface select-none">
          {/* Sidebar */}
          <div className="flex w-[150px] shrink-0 flex-col border-r border-white/5 py-5 px-4">
          ...
          <div className="flex-1 p-5 overflow-hidden flex flex-col min-w-0">
            <div className="flex items-center justify-between mb-4 shrink-0">
              ...
              <div className="flex items-center gap-1.5 bg-primary text-on-primary text-xs font-bold rounded-full px-4 py-2">
                + New Session
              </div>
            </div>
            ...
            <div className="grid grid-cols-[1.5fr_1fr] gap-4 flex-1 min-h-0">
              ...
              <div className="rounded-xl border border-white/8 bg-white/[0.02] p-4 flex flex-col min-h-0">
                <div className="flex gap-4 mb-3 text-xs font-sans shrink-0 overflow-hidden">
                  {TABS.map((tab, i) => (
                    <button
                      key={tab}
                ...
                <div className="relative flex-1 rounded-lg overflow-hidden bg-black/40 min-h-0">
                  ...
                  <motion.div
                    ...
                    animate={
                      isInView ? { opacity: [1, 0.4, 1] } : { opacity: 1 }
                    }
                    transition={
                      isInView
            ...
            <div className="grid grid-cols-3 gap-4 mt-4 pt-4 border-t border-white/5 shrink-0">
              {[
                {
                  time: "0:42",
                  label: "Long pause",
            ...
            <div className="block mt-2 shrink-0">
              <Waveform />
            </div>
          </div>
        </div>
