...
function FeedbackChip({ chip }: { chip: Chip }) {
  return (
    <motion.div
      className={`absolute z-10 flex items-center gap-1.5 whitespace-nowrap rounded-full border border-ink-line/80 bg-ink-soft/95 px-3 py-1.5 text-xs font-medium text-cream shadow-[0_8px_24px_-8px_rgba(0,0,0,0.6)] ${chip.className}`}
...
export function Hero() {
  return (
    <section id="top" className="relative overflow-hidden pt-16 pb-10 sm:pt-24">
      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-12 px-6 lg:grid-cols-2 lg:gap-8 lg:px-10">
        ...
        >
          ...
          <div className="mt-8 flex flex-wrap items-center gap-3">
            <a
              href="#waitlist"
              className="rounded-full bg-amber px-6 py-3 text-sm font-medium text-ink transition-colors hover:bg-amber-soft"
            >
              Early Adopters →
            </a>
            <a
              href="#waitlist"
              className="rounded-full border border-ink-line px-6 py-3 text-sm font-medium text-cream transition-colors hover:border-text-muted"
            >
              Waitlist
            </a>
          </div>
        ...
        >
          <div className="absolute inset-0 overflow-hidden rounded-3xl border border-ink-line/60">
            <Image
              src="/background.webp"
      ...
      <Reveal>
        <p className="mx-auto mt-14 max-w-xl px-6 text-center font-display text-sm italic text-amber-soft/80">
